...
*/
function saveCode() {
  var fileName = window.prompt('What would you like to name your file?', 'smartAgri')
  //doesn't save if the user quits the save prompt
  if(fileName){
    var blob = new Blob([Blockly.smartAgri.workspaceToCode()], {type: 'text/plain;charset=utf-8'});
...
function save() {
  ...
  var fileName = window.prompt('What would you like to name your file?', 'smartAgriXml');
  // Store data in blob.

...
Blockly.Blocks.base_delay={
	...
	init:function(){
		this.setColour(120);
		this.appendValueInput("DELAY_TIME","Number").appendField("Time Delay").setCheck("Number");
...
Blockly.Blocks.inout_buildin_led={
	...
	init:function(){
		this.setColour(190);
		this.appendDummyInput().appendField("Build-in LED Stat").appendField(new Blockly.FieldDropdown([["ON","1"],["OFF","0"]]),"STAT");
		this.setPreviousStatement(!0,null);
		this.setNextStatement(!0,null);
...
Blockly.Blocks.inout_digital_write={
	...
	init:function(){
		this.setColour(230);
		this.appendDummyInput().appendField("Digital Write PIN#").appendField(new Blockly.FieldDropdown(profile["default"].digital),"PIN").appendField("Stat").appendField(new Blockly.FieldDropdown([["ON","1"],["OFF","0"]]),"STAT");
		this.setPreviousStatement(!0,null);
		this.setNextStatement(!0,null);
...
Blockly.Blocks.inout_digital_read={
	...
	init:function(){
		this.setColour(330);
		this.appendDummyInput().appendField("Digital Read PIN#").appendField(new Blockly.FieldDropdown(profile["default"].digital),"PIN");
...
Blockly.Blocks.inout_analog_write={
	...
	init:function(){
		this.setColour(120);
		this.appendDummyInput().appendField("Analog Write PIN#").appendField(new Blockly.FieldDropdown(profile["default"].analog),"PIN");
...
Blockly.Blocks.inout_analog_read={
	...
	init:function(){
		this.setColour(330);
		this.appendDummyInput().appendField("Analog Read PIN#").appendField(new Blockly.FieldDropdown(profile["default"].analog),"PIN");
...
Blockly.Blocks.new_map={
	...
	init: function() {
	    this.appendValueInput("VAL")
	        .setCheck(null)
	        .appendField("Map form");
	    this.appendValueInput("MAX_IN")
	        .setCheck(null)
	        .appendField("In [0 -");
	    this.appendValueInput("MAX_OUT")
	        .setCheck(null)
	        .appendField("To Out [0 -");
...
// new setup_initial fucntion
Blockly.Blocks.setup_initial ={
	helpUrl:"",
	init: function() {
    	this.appendDummyInput()
        	.appendField("Setup Initial");
    	this.appendStatementInput("Setup_Initial")
        	.setCheck(null);
...
// new pwm_out fucntion
Blockly.Blocks.pwm_out ={
	helpUrl:"",
	init: function() {
	    this.appendDummyInput()
	        .appendField("PWM OUT")
	        .appendField(new Blockly.FieldImage("https://images-na.ssl-images-amazon.com/images/I/31j41t1Y27L._SX342_.jpg", 82, 82, "*"))
	        .appendField("PIN#")
	        .appendField(new Blockly.FieldDropdown([["D4","4"], ["D5","5"]]), "PIN");
	    this.appendValueInput("VAL_PWM")
	        .setCheck(null)
	        .setAlign(Blockly.ALIGN_RIGHT)
	        .appendField("Val [0-255]");
	    //this.setInputsInline(true);
	    this.setPreviousStatement(true, null);
	    this.setNextStatement(true, null);
	    this.setColour(240);
...
// new pwm_out_percent fucntion
Blockly.Blocks.pwm_out_percent ={
	helpUrl:"",
	init: function() {
	    this.appendDummyInput()
	        .appendField("PWM OUT")
...
//new output Y
Blockly.Blocks.outputY_write={
	helpUrl:"",
	init:function(){
		this.setColour(330);
		this.appendDummyInput().appendField("Output Y Write PIN#")
		.appendField(new Blockly.FieldDropdown(profile["default"].outputY),"PIN")
		.appendField("Stat").appendField(new Blockly.FieldDropdown([["ON","1"],["OFF","0"]]),"STAT");
		this.setPreviousStatement(true,null);
		this.setNextStatement(true,null);
		this.setTooltip("Write digital value to a specific Port")
	}
...
//new output Y 2
Blockly.Blocks.outputY_write_2={
	helpUrl:"",
	init: function() {
	    this.appendValueInput("PIN")
	        .setCheck(null)
	        .appendField("Output Y Write PIN#");
...
//new input x
Blockly.Blocks.inputX_read={
	helpUrl:"",
	init:function(){
		this.setColour(120);
		this.appendDummyInput().appendField("Input X Read PIN#")
		.appendField(new Blockly.FieldDropdown(profile["default"].inputX),"PIN");
		this.setOutput(true,null); 
		this.setTooltip("")
	}
};
//new input x 2
Blockly.Blocks.inputX_read_2={
	helpUrl:"",
	init: function() {
	    this.appendValueInput("PIN")
	        .setCheck(null)
	        .appendField("Input X Read PIN#");
	    this.setInputsInline(true);
	    this.setOutput(true, null);
	    this.setColour(120);
	 	this.setTooltip("");
...
Blockly.Blocks.adc_read={
	...
	init:function(){
		this.setColour(120);
		this.appendDummyInput().appendField("Input ADC Read PIN#")
		.appendField(new Blockly.FieldDropdown(profile["default"].adc),"PIN");
...
Blockly.Blocks.sensor_water_flow_read={
	helpUrl:"",
	init:function(){
		this.setColour(120);
		this.appendDummyInput().appendField("Water Flow Read PIN#")
		.appendField(new Blockly.FieldImage("img/Sensor-Water-Flow.jpg",64,64))
		.appendField(new Blockly.FieldDropdown(profile["default"].interrupt),"PIN")
		.appendField(" Type :")
		.appendField(new Blockly.FieldDropdown([["perSec","0"],["perMins","1"],["perHours","2"]]),"TYPE");
		this.setOutput(true,"Number");
		this.setTooltip("")
	}
};
...
//new input sensor pH
Blockly.Blocks.sensor_pH_read={
	helpUrl:"",
	init:function(){
		this.setColour(330);
		this.appendDummyInput().appendField("pH Read PIN#")
		.appendField(new Blockly.FieldImage("img/Sensor-pH.jpg",128,64))
...
Blockly.Blocks.sensor_temp_read={
	helpUrl:"",
	init:function(){
		this.setColour(120);
		this.appendDummyInput().appendField("Temp Read PIN#")
		.appendField(new Blockly.FieldImage("img/Sensor-DHT22.jpg",64,64))
		.appendField(new Blockly.FieldDropdown(profile["default"].interrupt),"PIN");
		this.setOutput(true,"Number");
		this.setTooltip("")
	}
...
Blockly.Blocks.sensor_humid_read={
	helpUrl:"",
	init:function(){
		this.setColour(330);
		this.appendDummyInput().appendField("Humid Read PIN#")
		.appendField(new Blockly.FieldImage("img/Sensor-DHT22.jpg",64,64))
		.appendField(new Blockly.FieldDropdown(profile["default"].interrupt),"PIN");
		this.setOutput(true,"Number");
		this.setTooltip("")
...
Blockly.Blocks.sensor_ldr_read={
	helpUrl:"",
	init:function(){
		this.setColour(120);
		this.appendDummyInput().appendField("LDR Read PIN#")
		.appendField(new Blockly.FieldImage("img/Sensor-LDR.jpg",64,64))
		.appendField(new Blockly.FieldDropdown(profile["default"].analog),"PIN");
		this.setOutput(!0,"Number");
		this.setTooltip("Return value between 0 and 1024")
	}
...
Blockly.Blocks.sensor_ambient_light_read={
	helpUrl:"",
	init:function(){
		this.appendDummyInput()
        .appendField("Ambient Light Read ")
        .appendField(new Blockly.FieldImage("img/Sensor-Ambient-Light-BH1750.jpg", 64, 64, "*"))
        .appendField("#Addr 0x27");
	    this.setOutput(true, null);
	    this.setColour(230);
	 	this.setTooltip("");
	 	this.setHelpUrl("");
...
Blockly.Blocks.sensor_soil_moisture_read={
	helpUrl:"",
	init:function(){
		this.setColour(120);
		this.appendDummyInput().appendField("Soil Moisture Read PIN#")
		.appendField(new Blockly.FieldImage("img/Sensor-Soil-Moisture.jpg",64,64))
		.appendField(new Blockly.FieldDropdown(profile["default"].analog),"PIN");
		this.setOutput(true,"Number");
		this.setTooltip("")
	}
...
Blockly.Blocks.sensor_co2_read={
	helpUrl:"",
	init:function(){
		this.setColour(330);
		this.appendDummyInput().appendField("Co2 Read PIN#")
		.appendField(new Blockly.FieldImage("img/Sensor-Co2.jpg",64,64))
		.appendField(new Blockly.FieldDropdown(profile["default"].interrupt),"PIN")
		.appendField(" Type :")
		.appendField(new Blockly.FieldDropdown([["Value","0"],["H","1"],["L","2"]]),"TYPE");
		this.setOutput(true,"Number");
		this.setTooltip("")
	}
};
...
Blockly.Blocks.sensor_co2_mg811_read={
	helpUrl:"",
	init:function(){
		this.setColour(330);
		this.appendDummyInput().appendField("Co2 MG811 Read PIN#")
		.appendField(new Blockly.FieldImage("img/Sensor-Co2-MG811.jpg",64,64))
		.appendField(new Blockly.FieldDropdown(profile["default"].adc),"PIN");
		this.setOutput(true,"Number");
		this.setTooltip("")
	}
...
Blockly.Blocks.sensor_windspeed_read={
	helpUrl:"",
	init:function(){
		this.setColour(120);
		this.appendDummyInput().appendField("Wind Speed Read PIN#")
		.appendField(new Blockly.FieldImage("img/Sensor-Wind-Speed.jpg",64,64))
		.appendField(new Blockly.FieldDropdown(profile["default"].interrupt),"PIN");
		this.setOutput(!0,"Number");
		this.setTooltip("")
	}
...
Blockly.Blocks.sensor_raingauge_read={
	helpUrl:"",
	init:function(){
		this.setColour(120);
		this.appendDummyInput().appendField("Rain Gauge Read PIN#")
		.appendField(new Blockly.FieldImage("img/Sensor-Wind-Gauge.jpg",64,64))
		.appendField(new Blockly.FieldDropdown(profile["default"].interrupt),"PIN");
		this.setOutput(!0,"Number");
		this.setTooltip("Return value between 0 and 1024")
	}
...
Blockly.Blocks.sensor_windvane_read={
	helpUrl:"",
	init:function(){
		this.setColour(120);
		this.appendDummyInput().appendField("Wind Vane Read PIN#")
		.appendField(new Blockly.FieldImage("img/Sensor-Wind-Vane.png",64,64))
		.appendField(new Blockly.FieldDropdown(profile["default"].adc),"PIN")
		.appendField(" Type :")
		.appendField(new Blockly.FieldDropdown([["String","0"],["Number","1"]]),"TYPE");
		this.setOutput(!0,"Number");
		this.setTooltip("Return value between 0 and 1024")
	}
};
...
Blockly.Blocks.sensor_tds_read={
	helpUrl:"",
	init:function(){
		this.setColour(330);
		this.appendDummyInput().appendField("TDS Read PIN#")
		.appendField(new Blockly.FieldImage("https://www.robotshop.com/media/files/images3/rb-dfr-797.jpg",120,80))
		.appendField(new Blockly.FieldDropdown(profile["default"].analog),"PIN");
		this.setOutput(!0,"Number");
		this.setTooltip("Return value between 0 and 1024")
	}
...
Blockly.Blocks.sensor_ds18b20_read={
	helpUrl:"",
	init:function(){
		this.setColour(330);
		this.appendDummyInput().appendField("DS18B20 Read PIN#")
		.appendField(new Blockly.FieldImage("img/Sensor-DS18B20-Temp.jpg",120,80))
		.appendField(new Blockly.FieldDropdown(profile["default"].interrupt),"PIN")
		.appendField(" Unit :")
		.appendField(new Blockly.FieldDropdown([["Celcius","0"],["Fahrenheit","1"]]),"TYPE");
		this.setOutput(true,"Number");
		this.setTooltip("Return value between 0 and 1024")
	}
};
...
Blockly.Blocks.sensor_water_level_liquid={
	helpUrl:"",
	init: function() {
    this.appendDummyInput()
        .appendField("Water Level Liquid Sensor Read PIN#")
        .appendField(new Blockly.FieldImage("img/Sensor-Water-Level-Liquid.png", 94, 94, "*"))
        .appendField(new Blockly.FieldDropdown(profile["default"].interrupt),"PIN")
        .appendField("Active")
        .appendField(new Blockly.FieldDropdown([["Low","0"], ["High","1"]]), "TYPE");
    this.setOutput(true, null);
    this.setColour(270);
 	this.setTooltip("");
 	this.setHelpUrl("");
...
//new display LCD set address
Blockly.Blocks.display_lcd_setaddress={
	helpUrl:"",
	init: function() {
	    this.appendDummyInput()
	        .appendField("set LCD Display ")
...
Blockly.Blocks.display_lcd={
	...
	init: function() {
        ...
        .appendField("setCol")
        .appendField(new Blockly.FieldDropdown(profile["default"].lcdletter),"COL")
        .appendField("setRow")
        .appendField(new Blockly.FieldDropdown(profile["default"].lcdcursor),"ROW")
        .appendField("Text");
	    this.setInputsInline(true);
	    this.setPreviousStatement(true, null);
	    this.setNextStatement(true, null);
...
//new display sevenseg max7219
Blockly.Blocks.sevenseg_max7219_setpin={
	helpUrl:"",
	init: function() {
    this.appendDummyInput()
        .appendField("set Max7219 ")
        .appendField("DIN ")
        .appendField(new Blockly.FieldDropdown(profile["default"].digital),"DIN")
        .appendField("LOAD ")
        .appendField(new Blockly.FieldDropdown(profile["default"].digital),"LOAD")
        .appendField("CLK")
...
//new display sevenseg max7219
Blockly.Blocks.sevenseg_max7219={
	helpUrl:"",
	init:function(){
		this.setColour(330);
		this.appendDummyInput().appendField("Display 7Seg Max7219");
		this.appendValueInput("MAX7219_NUM","Number").appendField("Number Int").setCheck("Number");
		this.appendDummyInput().appendField("setDigit").appendField(new Blockly.FieldDropdown(profile["default"].sevenseg_digit),"DIGIT");
		this.setInputsInline(!0);
		this.setPreviousStatement(!0,null);
		this.setNextStatement(!0,null);
...
//new display sevenseg max7219 float
Blockly.Blocks.sevenseg_max7219_float={
	helpUrl:"",
	init:function(){
		this.setColour(230);
		this.appendDummyInput().appendField("Display 7Seg Max7219");
		this.appendValueInput("MAX7219_NUM","Number").appendField("Number Float").setCheck("Number");
		this.appendDummyInput().appendField("setDigit").appendField(new Blockly.FieldDropdown(profile["default"].sevenseg_digit),"DIGIT");
		this.setInputsInline(!0);
		this.setPreviousStatement(!0,null);
		this.setNextStatement(!0,null);
...
Blockly.Blocks.time_rtc_years_read={
	helpUrl:"",
	init:function(){
		this.setColour(0);
		this.appendDummyInput().appendField("Time RTC Years");
		this.setOutput(!0,"Number");
		this.setTooltip("Return value between 0 and 24")
	}
};
//new time rtc months read
Blockly.Blocks.time_rtc_months_read={
	helpUrl:"",
	init:function(){
		this.setColour(120);
		this.appendDummyInput().appendField("Time RTC Months");
		this.setOutput(!0,"Number");
		this.setTooltip("Return value between 0 and 24")
	}
};
//new time rtc days read
Blockly.Blocks.time_rtc_days_read={
	helpUrl:"",
	init:function(){
		this.setColour(230);
		this.appendDummyInput().appendField("Time RTC Days");
		this.setOutput(!0,"Number");
		this.setTooltip("Return value between 0 and 24")
	}
};
//new time rtc hours read
Blockly.Blocks.time_rtc_hours_read={
	helpUrl:"",
	init:function(){
		this.setColour(0);
		this.appendDummyInput().appendField("Time RTC Hours");
		this.setOutput(!0,"Number");
		this.setTooltip("Return value between 0 and 24")
	}
};
//new time rtc mins read
Blockly.Blocks.time_rtc_mins_read={
	helpUrl:"",
	init:function(){
		this.setColour(120);
		this.appendDummyInput().appendField("Time RTC Minutes");
		this.setOutput(!0,"Number");
		this.setTooltip("Return value between 0 and 60")
	}
};
//new time rtc seconds read
Blockly.Blocks.time_rtc_seconds_read={
	helpUrl:"",
	init:function(){
		this.setColour(230);
		this.appendDummyInput().appendField("Time RTC Seconds");
		this.setOutput(!0,"Number");
		this.setTooltip("Return value between 0 and 60")
	}
};
//new time rtc delay
Blockly.Blocks.time_rtc_seconds_delay={
	helpUrl:"",
	init:function(){
		this.setColour(320);
		this.appendDummyInput().appendField("Time RTC Seconds Delay");
		this.appendValueInput("Time_RTC_Seconds_Delay","Number").appendField("Value").setCheck("Number");
		this.setOutput(!0,"Boolean");
		this.setInputsInline(!0);
		this.appendDummyInput().appendField(" seconds");
		this.setTooltip("Return Boolean")
	}
};


//new convert text to int 
Blockly.Blocks.convert_texttoint={
	helpUrl:"http://arduino.cc/en/Reference/delay",
	init:function(){
		this.setColour(120);
		this.appendDummyInput().appendField("Text To Number");
		this.appendValueInput("VALUE_IN","Number").appendField("Text");//.setCheck("Number");
		this.setInputsInline(!0);
		this.setOutput(!0,"Number");
		this.setTooltip("Delay specific time")
	}
...
Blockly.Blocks.add_text_to_text={
	helpUrl:"",
	init:function(){
		this.setColour(230);
		this.appendDummyInput().appendField("Add Text To Text");
		this.appendValueInput("STRING_TO","String to ").appendField("Text1");
		this.appendValueInput("STRING_TO2","String").appendField("Text2");
		this.setInputsInline(!0);
...
Blockly.Blocks.get_text_form_preamble = {
	helpUrl:"",
  	init: function() {
	    this.appendValueInput("GET_PRE")
	        .appendField("get Text")
	        .appendField("Preamble");
	    this.appendValueInput("GET_DATA")
	        .appendField("Text");
	    this.appendValueInput("GET_END")
	        .appendField("End");
	    this.setInputsInline(true);
	    this.setOutput(true, null);
	    this.setColour(240);
...
Blockly.Blocks.set_text_form_preamble = {
	helpUrl:"",
  	init: function() {
	    this.appendValueInput("GET_PRE")
...
//new build nodeMCU WiFi
Blockly.Blocks.build_nodemcu_module_wifi={
	helpUrl:"",
	init:function(){
		this.setColour(230);
		this.appendDummyInput().appendField("Build NodeMCU Module WiFi");
		this.appendValueInput("SSID","SSID").appendField("SSID");
		this.appendValueInput("Password","Password").appendField("Password");
		this.setInputsInline(!0);
		this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
		this.setTooltip("Build nodeMCU for use WiFi")
	}
};


//new nodemcu get http
Blockly.Blocks.nodemcu_get_https={
	helpUrl:"",
	init:function(){
		this.setColour(230);
		this.appendDummyInput().appendField("NodeMCU Get HTTP");
		this.appendValueInput("URL","String to ").appendField("Url");
		this.setInputsInline(!0);
		this.setOutput(!0,"String");
		this.setTooltip("return String")
	}
};

//new nodemcu get last field
Blockly.Blocks.nodemcu_get_lastfield_thingspeak={
	helpUrl:"",
	init: function() {
    	this.appendValueInput("CHANNEL")
        .setCheck(null)
        .appendField("NodeMCU get LastField Thingspeak")
        .appendField("at Channel");
    	this.appendValueInput("ATFIELD")
        .setCheck(null)
        .appendField("at Field");
    	this.setInputsInline(true);
    	this.setOutput(true, null);
    	this.setColour(230);
	 	this.setTooltip("");
...
Blockly.Blocks.nodemcu_up_thingspeak={
	helpUrl:"",
	init: function() {
	    this.appendValueInput("API_KEY")
	        .setCheck("String")
	        .appendField("NodeMCU UpThingSpeak")
	        .appendField("API_KEY");
	    this.appendValueInput("SET_FIELD")
	        .setCheck("Number")
	        .appendField("numField");
	    this.appendValueInput("DATA_FIELD")
	        .setCheck(null)
	        .appendField("dataField");
	    this.setInputsInline(true);
	    this.setPreviousStatement(true, null);
	    this.setNextStatement(true, null);
	    this.setColour(255);
...
//new nodemcu_up_thingspeak 2
Blockly.Blocks.nodemcu_up_thingspeak2={
	helpUrl:"",
	init: function() {
    this.appendValueInput("API_KEY")
        .setCheck(null)
        .appendField("NodeMCU UpThingSpeak")
        .appendField("API_KEY");
    this.appendValueInput("DATA_FIELD1")
        .setCheck(null)
        .setAlign(Blockly.ALIGN_RIGHT)
        .appendField("Data Field 1");
    this.appendValueInput("DATA_FIELD2")
        .setCheck(null)
        .setAlign(Blockly.ALIGN_RIGHT)
        .appendField("Data Field 2");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(285);
	this.setTooltip("");
...
//new nodemcu_up_thingspeak 4
Blockly.Blocks.nodemcu_up_thingspeak4={
	helpUrl:"",
	init: function() {
    this.appendValueInput("API_KEY")
        .setCheck(null)
    ...
    this.appendValueInput("DATA_FIELD2")
        ...
        .setAlign(Blockly.ALIGN_RIGHT)
        .appendField("Data Field 2");
    this.appendValueInput("DATA_FIELD3")
    	.setCheck(null)
    	.setAlign(Blockly.ALIGN_RIGHT)
    	.appendField("Data Field 3");
    this.appendValueInput("DATA_FIELD4")
    	.setCheck(null)
    	.setAlign(Blockly.ALIGN_RIGHT)
    	.appendField("Data Field 4");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(285);
	this.setTooltip("");
...
//new build nrf24l01
Blockly.Blocks.build_nrf24l01={
	helpUrl:"",
	init:function(){
		this.setColour(230);
		this.appendDummyInput().appendField("Build NRF24L01");
		this.appendValueInput("CH","Channel").appendField("Channel");
		this.appendValueInput("RXADDRESS","Rxaddress").appendField("Rxaddress");
		this.appendValueInput("TXADDRESS","Txaddress").appendField("Txaddress");
		this.setInputsInline(!0);
		this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
		this.setTooltip("Build NRF24L01")
	}
};
//new IoT-Smart nrf24l01 read
Blockly.Blocks.nrf24l01_read={
	helpUrl:"",
	init:function(){
		this.setColour(120);
		this.appendDummyInput().appendField("NRF24L01 Read");
		this.setOutput(!0,null);
		this.setTooltip("Return value between 0 and 1024")
	}
};
//new IoT-Smart nrf24l01 send
Blockly.Blocks.nrf24l01_send={
	helpUrl:"",
	init:function(){
		this.setColour(230);
		this.appendDummyInput().appendField("NRF24L01 Write");
		this.appendValueInput("SEND_RF","String").appendField("Text");
		this.setInputsInline(true);
		this.setPreviousStatement(true,null);
		this.setNextStatement(true,null);
		this.setTooltip("Return value between 0 and 1024")
...
//new  set seral port
Blockly.Blocks.set_serial_port={
	helpUrl:"",
	init:function(){
		this.appendDummyInput()
        .appendField("set Serial Port")
...
//new seral print type
Blockly.Blocks.serial_print_type={
	helpUrl:"",
	init:function(){
		this.setColour(230);
		this.appendValueInput("CONTENT","String").appendField("Serial Print");
		this.appendDummyInput().appendField("Type").appendField(new Blockly.FieldDropdown(profile["default"].type_print),"TYPE_PRINT");
		this.setPreviousStatement(true,null);
		this.setNextStatement(true,null);
		this.setTooltip("Prints data to the console/serial port as human-readable ASCII text.")
	}
};
//new seral print new line
Blockly.Blocks.serial_println={
	helpUrl:"",
	init:function(){
		this.setColour(230);
		this.appendValueInput("CONTENT","String").appendField("Serial Print new line");
		this.setPreviousStatement(true,null);
		this.setNextStatement(true,null);
		this.setTooltip("Prints data to the console/serial port as human-readable ASCII text.")
	}
};
Blockly.Blocks.serial_println_type={
	helpUrl:"",
	init:function(){
		this.setColour(230);
		this.appendValueInput("CONTENT","String").appendField("Serial Print new line");
...
//new read uart
Blockly.Blocks.read_uart={
	helpUrl:"",
	init:function(){
		this.setColour(230);
		this.appendDummyInput().appendField("Read UART");
		this.setOutput(true,null);
		this.setTooltip("Prints data to the console/serial port as human-readable ASCII text.")
	}
};
//new send uart
Blockly.Blocks.send_uart={
	helpUrl:"",
	init:function(){
		this.setColour(230);
		this.appendValueInput("SEND_UART","String").appendField("Send UART");
		this.setPreviousStatement(true,null);
		this.setNextStatement(true,null);
		this.setTooltip("Prints data to the console/serial port as human-readable ASCII text.")
	}
...
//new send uart
Blockly.Blocks.send_uart_newline={
	helpUrl:"",
	init:function(){
		this.setColour(230);
		this.appendValueInput("SEND_UART_NEWLINE","String").appendField("Send UART Newline");
		this.setPreviousStatement(true,null);
		this.setNextStatement(true,null);
		this.setTooltip("Prints data to the console/serial port as human-readable ASCII text.")
	}
...
Blockly.Blocks.servo_move={
	...
	init:function(){
		this.setColour(190);
		this.appendDummyInput().appendField("Servo").appendField(new Blockly.FieldImage("img/Sensor-Servo-S3003.jpg",128,64)).appendField("PIN#").appendField(new Blockly.FieldDropdown(profile["default"].digital),"PIN");
...
Blockly.Blocks.Set_Function_Timer ={
	helpUrl:"",
	init: function() {
    	this.appendDummyInput()
        	.appendField("set Function Timer1");
    	this.appendStatementInput("Timer_Loop")
        	.setCheck(null);
        this.setPreviousStatement(true,null);
		this.setNextStatement(true,null);
    	this.setColour(240);
...
Blockly.Blocks.Set_Timer={
	helpUrl:"",
	init: function() {
	    this.appendValueInput("Time_End")
	        .setCheck(null)
	        .setAlign(Blockly.ALIGN_RIGHT)
	        .appendField("set Timer Sec --> MAX ");
	    this.setPreviousStatement(true, null);
	    this.setNextStatement(true, null);
	    this.setColour(240);
	 	this.setTooltip("");
...
// new LowCost PLC Timer Stop 
Blockly.Blocks.Timer_Stop={
	helpUrl:"",
	init: function() {
	    this.appendDummyInput()
	        .appendField("Timer Sec --> Stop");
	    this.setPreviousStatement(true, null);
	    this.setNextStatement(true, null);
	    this.setColour(240);
	 	this.setTooltip("");
...
Blockly.Blocks.Timer_Val={
	helpUrl:"",
	init: function() {
	    this.appendDummyInput()
	        .appendField("Timer Sec --> Val");
	    this.setOutput(true, null);
	    this.setColour(240);
	 	this.setTooltip("");
	 	this.setHelpUrl("");
...
Blockly.Blocks.Set_Counter={
	helpUrl:"",
	init: function() {
	    this.appendValueInput("Counter_End")
	        .setCheck(null)
	        .setAlign(Blockly.ALIGN_RIGHT)
	        .appendField("set Counter --> MAX ");
	    this.setPreviousStatement(true, null);
	    this.setNextStatement(true, null);
	    this.setColour(240);
	 	this.setTooltip("");
...
Blockly.Blocks.Counter_Reset={
	helpUrl:"",
	init: function() {
	    this.appendDummyInput()
	        .appendField("Counter --> Reset");
	    this.setPreviousStatement(true, null);
	    this.setNextStatement(true, null);
	    this.setColour(240);
	 	this.setTooltip("");
...
Blockly.Blocks.Counter_UP={
	helpUrl:"",
	init: function() {
	    this.appendDummyInput()
	        .appendField("Counter --> UP");
	    this.setPreviousStatement(true, null);
	    this.setNextStatement(true, null);
	    this.setColour(240);
	 	this.setTooltip("");
...
Blockly.Blocks.Counter_Down={
	helpUrl:"",
	init: function() {
	    this.appendDummyInput()
	        .appendField("Counter --> Down");
	    this.setPreviousStatement(true, null);
	    this.setNextStatement(true, null);
	    this.setColour(240);
	 	this.setTooltip("");
...
Blockly.Blocks.Counter_Val={
	helpUrl:"",
	init: function() {
	    this.appendDummyInput()
	        .appendField("Counter --> Val");
	    this.setOutput(true, null);
	    this.setColour(240);
	 	this.setTooltip("");
	 	this.setHelpUrl("");
...
Blockly.Blocks.inout_highlow={
	...
	init:function(){
		this.setColour(230);
		this.appendDummyInput().appendField(new Blockly.FieldDropdown([["HIGH","1"],["LOW","0"]]),"BOOL");
		this.setOutput(!0,"Boolean");
		this.setTooltip("")
	}
};
...
Blockly.Blocks.grove_led={
	...
	init:function(){
		this.setColour(190);
		this.appendDummyInput().appendField("LED").appendField(new Blockly.FieldImage("https://statics3.seeedstudio.com/images/product/groveblue%20white.jpg",64,64)).appendField("PIN#").appendField(new Blockly.FieldDropdown(profile["default"].digital),"PIN").appendField("stat").appendField(new Blockly.FieldDropdown([["ON","ON"],["OFF","OFF"]]),"STAT");
		this.setPreviousStatement(!0,null);
		this.setNextStatement(!0,null);
...
Blockly.Blocks.grove_piezo_buzzer={
	...
	init:function(){
		this.setColour(190);
		this.appendDummyInput().appendField("Piezo Buzzer").appendField(new Blockly.FieldImage("https://statics3.seeedstudio.com/images/107020000%201.jpg",64,64)).appendField("PIN#").appendField(new Blockly.FieldDropdown(profile["default"].digital),"PIN").appendField("stat").appendField(new Blockly.FieldDropdown([["ON","ON"],["OFF","OFF"]]),"STAT");
		this.setPreviousStatement(!0,null);
		this.setNextStatement(!0,null);
...
Blockly.Blocks.grove_relay={
	...
	init:function(){
		this.setColour(190);
		this.appendDummyInput().appendField("Relay").appendField(new Blockly.FieldImage("https://statics3.seeedstudio.com/images/1030200051.jpg",64,64)).appendField("PIN#").appendField(new Blockly.FieldDropdown(profile["default"].digital),"PIN").appendField("stat").appendField(new Blockly.FieldDropdown([["ON","ON"],["OFF","OFF"]]),"STAT");
		this.setPreviousStatement(!0,null);
		this.setNextStatement(!0,null);
...
Blockly.Blocks.grove_serial_lcd_power={
	...
	init:function(){
		this.setColour(190);
		this.appendDummyInput().appendField("Serial LCD").appendField(new Blockly.FieldImage("https://statics3.seeedstudio.com/images/product/Serial%20LCD.jpg",64,64)).appendField("PIN#").appendField(new Blockly.FieldDropdown(profile["default"].digital),"PIN");
		this.appendDummyInput().setAlign(Blockly.ALIGN_RIGHT).appendField("Power").appendField(new Blockly.FieldDropdown([["ON","ON"],["OFF","OFF"]]),"STAT");
		this.setPreviousStatement(!0,null);
		this.setNextStatement(!0,null);
...
Blockly.Blocks.grove_serial_lcd_effect={
	...
	init:function(){
		this.setColour(190);
		this.appendDummyInput().appendField("Serial LCD").appendField(new Blockly.FieldImage("https://statics3.seeedstudio.com/images/product/Serial%20LCD.jpg",64,64)).appendField("PIN#").appendField(new Blockly.FieldDropdown(profile["default"].digital),"PIN");
		this.appendDummyInput().setAlign(Blockly.ALIGN_RIGHT).appendField("Effect").appendField(new Blockly.FieldDropdown([["Scroll Left","LEFT"],["Scroll Right","RIGHT"],["Scroll Auto","AUTO"]]),"STAT");
		this.setPreviousStatement(!0,null);
		this.setNextStatement(!0,null);
		this.setTooltip("Turn LCD power on/off")
	}
...
Blockly.Blocks.grove_sound_sensor={
	...
	init:function(){
		...
		this.setOutput(!0,"Number");this.setTooltip("Detect the sound strength of the environment")
	}
};
...
Blockly.Blocks.grove_ultrasonic_ranger={
	...
	init:function(){
		this.setColour(190);
		this.appendDummyInput().appendField("Ultrasonic Ranger").appendField(new Blockly.FieldImage("https://statics3.seeedstudio.com/seeed/img/2016-09/kIyY21sbC6ct7JYzCWf1mAPs.jpg",64,64)).appendField("PIN#").appendField(new Blockly.FieldDropdown(profile["default"].digital),"PIN").appendField("unit").appendField(new Blockly.FieldDropdown([["cm","cm"],["inch","inch"]]),"UNIT");
		this.setOutput(!0,"Number");this.setTooltip("Non-contact distance measurement module")
	}
};
Blockly.Blocks.grove_motor_shield={
	...
	init:function(){
		this.setColour(190);
		this.appendDummyInput().appendField("Motor").appendField(new Blockly.FieldImage("http://wiki.seeedstudio.com/images/4/4d/Smotoshield2.jpg",64,64)).appendField(new Blockly.FieldDropdown([["Stop","stop"],["Forward","forward"],["Right","right"],["Left","left"],["Backward","backward"]]),"DIRECTION");
		this.setPreviousStatement(!0,null);
		this.setNextStatement(!0,null);
...
Blockly.Blocks.grove_thumb_joystick={
	...
	init:function(){
		this.setColour(10);
		this.appendDummyInput().appendField("Thumb Joystick").appendField(new Blockly.FieldImage("https://statics3.seeedstudio.com/images/product/bgjoy1.jpg",64,64)).appendField("PIN#").appendField(new Blockly.FieldDropdown(profile["default"].analog),"PIN").appendField("axis").appendField(new Blockly.FieldDropdown([["x","x"],["y","y"]]),"AXIS");
		this.setOutput(!0,"Number");
...
Blockly.Blocks.grove_rgb_led={
	...
	init:function(){
		...
		mutationToDom:function(){
			var a=document.createElement("mutation");a.setAttribute("items",this.itemCount_);
			for(var b=0;b<this.itemCount_;b++){
				var c=this.getFieldValue("RGB0");a.setAttribute("RGB"+b,c)
			}return a
		...
		this.appendDummyInput("COLOR"+b).setAlign(Blockly.ALIGN_RIGHT).appendField("Color "+(b+1)).appendField(new Blockly.FieldColour(c),"RGB"+b)}0==
		this.itemCount_&&this.appendDummyInput("COLOR0").setAlign(Blockly.ALIGN_RIGHT).appendField("Color 1").appendField(new Blockly.FieldColour("#00ff00"),"RGB0")},
		decompose:function(a){
			var b=Blockly.Block.obtain(a,"grove_rgb_led_container");b.initSvg();
			for(var c=b.getInput("STACK").connection,d=0;d<this.itemCount_;d++){
				...
				compose:function(a){
					...
					else for(var b=this.itemCount_-1;0<=b;b--)
					this.removeInput("COLOR"+b);
					this.itemCount_=0;
					for(a=a.getInputTargetBlock("STACK");
						a;){
						b=this.getFieldValue("RGB"+this.itemCount_);null==b&&(b="00ff00");
					...
					this.itemCount_++;a=a.nextConnection&&a.nextConnection.targetBlock()}0==this.itemCount_&&this.appendDummyInput("COLOR0").setAlign(Blockly.ALIGN_RIGHT).appendField("Color 1").appendField(new Blockly.FieldColour("#00ff00"),"RGB0")
	}
};
...
Blockly.Blocks.grove_bluetooth_slave={
	...
	init:function(){
		...
		this.appendDummyInput().setAlign(Blockly.ALIGN_RIGHT).appendField("Name").appendField(new Blockly.FieldTextInput("blocklyduino"),"NAME");this.appendDummyInput().setAlign(Blockly.ALIGN_RIGHT).appendField("Pincode").appendField(new Blockly.FieldTextInput("0000"),"PINCODE");
...
Blockly.Blocks.lists.HUE=260;Blockly.Blocks.lists_create_empty={
	init:function(){
			...
			for(var c=b.getInput("STACK").connection,d=0;d<this.itemCount_;d++){
				...
				compose:function(a){
					...
					for(var b=[],c=0;a;)b[c]=a.valueConnection_,a=a.nextConnection&&a.nextConnection.targetBlock(),c++;
						this.itemCount_=c;this.updateShape_();
						for(c=0;c<this.itemCount_;c++)b[c]&&this.getInput("ADD"+c).connection.connect(b[c])},saveConnections:function(a){
							a=a.getInputTargetBlock("STACK");
							for(var b=0;a;){var c=this.getInput("ADD"+b);
								a.valueConnection_=c&&c.connection.targetConnection;b++;a=a.nextConnection&&a.nextConnection.targetBlock()}},
							updateShape_:function(){
								...
								if(0==this.itemCount_)this.appendDummyInput("EMPTY").appendField(Blockly.Msg.LISTS_CREATE_EMPTY_TITLE);
									...
									var b=this.appendValueInput("ADD"+a);0==a&&b.appendField(Blockly.Msg.LISTS_CREATE_WITH_INPUT_WITH)
								}
	}
};
...
Blockly.Blocks.lists_create_with_item={
	init:function(){
		...
		this.setPreviousStatement(!0);
		this.setNextStatement(!0);
		this.setTooltip(Blockly.Msg.LISTS_CREATE_WITH_ITEM_TOOLTIP);this.contextMenu=!1
	}
};
Blockly.Blocks.lists_repeat={
	init:function(){
		this.jsonInit({message0:Blockly.Msg.LISTS_REPEAT_TITLE,
			args0:[{type:"input_value",name:"ITEM"},{type:"input_value",name:"NUM",check:"Number"}],
			output:"Array",colour:Blockly.Blocks.lists.HUE,
...
Blockly.Blocks.lists_length={
	init:function(){
		this.jsonInit({message0:Blockly.Msg.LISTS_LENGTH_TITLE,
			args0:[{type:"input_value",name:"VALUE",check:["String","Array"]}],
			output:"Number",colour:Blockly.Blocks.lists.HUE,tooltip:Blockly.Msg.LISTS_LENGTH_TOOLTIP,helpUrl:Blockly.Msg.LISTS_LENGTH_HELPURL})
	}
};
Blockly.Blocks.lists_isEmpty={
	init:function(){
		this.jsonInit({message0:Blockly.Msg.LISTS_ISEMPTY_TITLE,
			args0:[{type:"input_value",name:"VALUE",check:["String","Array"]}],
			output:"Boolean",colour:Blockly.Blocks.lists.HUE,
...
Blockly.Blocks.lists_getIndex={
	init:function(){
		...
		this.setColour(Blockly.Blocks.lists.HUE);a=new Blockly.FieldDropdown(a,function(a){this.sourceBlock_.updateStatement_("REMOVE"==a)});
		...
		this.appendDummyInput("AT");Blockly.Msg.LISTS_GET_INDEX_TAIL&&this.appendDummyInput("TAIL").appendField(Blockly.Msg.LISTS_GET_INDEX_TAIL);
		this.setInputsInline(!0);this.setOutput(!0);
		this.updateAt_(!0);
		...
		function(b){var d="FROM_START"==b||"FROM_END"==b;if(d!=a){var e=this.sourceBlock_;e.updateAt_(d);e.setFieldValue(b,"WHERE");return null}});
...
Blockly.Blocks.lists_setIndex={
	init:function(){
		...
		this.updateAt_(!0);var b=this;this.setTooltip(function(){var a=b.getFieldValue("MODE")+"_"+b.getFieldValue("WHERE");return Blockly.Msg["LISTS_SET_INDEX_TOOLTIP_"+a]})},
		mutationToDom:function(){var a=document.createElement("mutation"),b=this.getInput("AT").type==Blockly.INPUT_VALUE;a.setAttribute("at",b);return a},
...
Blockly.Blocks.lists_getSublist={
	init:function(){
		...
		this.appendDummyInput("AT2");Blockly.Msg.LISTS_GET_SUBLIST_TAIL&&this.appendDummyInput("TAIL").appendField(Blockly.Msg.LISTS_GET_SUBLIST_TAIL);
		this.setInputsInline(!0);
		this.setOutput(!0,"Array");
		this.updateAt_(1,!0);
		this.updateAt_(2,!0);
		this.setTooltip(Blockly.Msg.LISTS_GET_SUBLIST_TOOLTIP)},
		mutationToDom:function(){var a=document.createElement("mutation"),b=this.getInput("AT1").type==Blockly.INPUT_VALUE;a.setAttribute("at1",b);b=this.getInput("AT2").type==Blockly.INPUT_VALUE;a.setAttribute("at2",b);return a},domToMutation:function(a){var b="true"==a.getAttribute("at1");a="true"==a.getAttribute("at2");
		this.updateAt_(1,b);
		this.updateAt_(2,a)},updateAt_:function(a,b){this.removeInput("AT"+a);
		this.removeInput("ORDINAL"+a,!0);b?(this.appendValueInput("AT"+a).setCheck("Number"),Blockly.Msg.ORDINAL_NUMBER_SUFFIX&&this.appendDummyInput("ORDINAL"+a).appendField(Blockly.Msg.ORDINAL_NUMBER_SUFFIX)):
		this.appendDummyInput("AT"+a);var c=new Blockly.FieldDropdown(this["WHERE_OPTIONS_"+a],function(c){var e="FROM_START"==c||"FROM_END"==c;if(e!=b){var f=this.sourceBlock_;f.updateAt_(a,e);f.setFieldValue(c,"WHERE"+a);return null}});
...
Blockly.Blocks.lists_split={
	init:function(){var a=this,b=new Blockly.FieldDropdown([[Blockly.Msg.LISTS_SPLIT_LIST_FROM_TEXT,"SPLIT"],[Blockly.Msg.LISTS_SPLIT_TEXT_FROM_LIST,"JOIN"]],function(b){"SPLIT"==b?(a.outputConnection.setCheck("Array"),a.getInput("INPUT").setCheck("String")):(a.outputConnection.setCheck("String"),a.getInput("INPUT").setCheck("Array"))});
	...
	this.setInputsInline(!0);
	this.setOutput(!0,"Array");
	this.setTooltip(function(){var b=a.getFieldValue("MODE");if("SPLIT"==b)return Blockly.Msg.LISTS_SPLIT_TOOLTIP_SPLIT;if("JOIN"==b)
		return Blockly.Msg.LISTS_SPLIT_TOOLTIP_JOIN;throw"Unknown mode: "+b;})
	}
};
...
Blockly.Blocks.controls_if={
	init:function(){
		...
		this.setPreviousStatement(!0);
		this.setNextStatement(!0);
		this.setMutator(new Blockly.Mutator(["controls_if_elseif","controls_if_else"]));var a=this;this.setTooltip(function(){if(a.elseifCount_||a.elseCount_){if(!a.elseifCount_&&a.elseCount_)return Blockly.Msg.CONTROLS_IF_TOOLTIP_2;if(a.elseifCount_&&!a.elseCount_)return Blockly.Msg.CONTROLS_IF_TOOLTIP_3;if(a.elseifCount_&&a.elseCount_)return Blockly.Msg.CONTROLS_IF_TOOLTIP_4}else return Blockly.Msg.CONTROLS_IF_TOOLTIP_1;return""});
		this.elseCount_=this.elseifCount_=0},mutationToDom:function(){if(!this.elseifCount_&&!this.elseCount_)return null;var a=document.createElement("mutation");this.elseifCount_&&a.setAttribute("elseif",this.elseifCount_);this.elseCount_&&a.setAttribute("else",1);return a},domToMutation:function(a){this.elseifCount_=parseInt(a.getAttribute("elseif"),10)||0;
		this.elseCount_=parseInt(a.getAttribute("else"),10)||0;for(a=1;a<=this.elseifCount_;a++)this.appendValueInput("IF"+a).setCheck("Boolean").appendField(Blockly.Msg.CONTROLS_IF_MSG_ELSEIF),this.appendStatementInput("DO"+a).appendField(Blockly.Msg.CONTROLS_IF_MSG_THEN);
...
Blockly.Blocks.logic_compare={
	init:function(){var a=this.RTL?[["=","EQ"],["\u2260","NEQ"],[">","LT"],["\u2265","LTE"],["<","GT"],["\u2264","GTE"]]:[["=","EQ"],["\u2260","NEQ"],["<","LT"],["\u2264","LTE"],[">","GT"],["\u2265","GTE"]];this.setHelpUrl(Blockly.Msg.LOGIC_COMPARE_HELPURL);
	this.setColour(Blockly.Blocks.logic.HUE);
	...
	this.prevBlocks_=[null,null]},onchange:function(){var a=this.getInputTargetBlock("A"),b=this.getInputTargetBlock("B");if(a&&b&&!a.outputConnection.checkType_(b.outputConnection))for(var c=0;c<this.prevBlocks_.length;c++){var d=
	this.prevBlocks_[c];if(d===a||d===b)d.setParent(null),d.bumpNeighbours_()}this.prevBlocks_[0]=a;this.prevBlocks_[1]=b
	}
};
Blockly.Blocks.logic_operation={
	init:function(){var a=[[Blockly.Msg.LOGIC_OPERATION_AND,"AND"],[Blockly.Msg.LOGIC_OPERATION_OR,"OR"]];
...
Blockly.Blocks.logic_negate={
	init:function(){
		this.jsonInit({message0:Blockly.Msg.LOGIC_NEGATE_TITLE,args0:[{type:"input_value",name:"BOOL",check:"Boolean"}],
			output:"Boolean",colour:Blockly.Blocks.logic.HUE,tooltip:
			Blockly.Msg.LOGIC_NEGATE_TOOLTIP,helpUrl:
			Blockly.Msg.LOGIC_NEGATE_HELPURL})
	}
};

Blockly.Blocks.logic_boolean={
	init:function(){var a=[[Blockly.Msg.LOGIC_BOOLEAN_TRUE,"TRUE"],[Blockly.Msg.LOGIC_BOOLEAN_FALSE,"FALSE"]];
...
Blockly.Blocks.logic_ternary={
	init:function(){
		...
		this.prevParentConnection_=null},onchange:function(){var a=
		this.getInputTargetBlock("THEN"),b=this.getInputTargetBlock("ELSE"),c=this.outputConnection.targetConnection;
		if((a||b)&&c)for(var d=0;2>d;d++){var e=1==d?a:b;e&&!e.outputConnection.checkType_(c)&&(c===this.prevParentConnection_?(this.setParent(null),c.sourceBlock_.bumpNeighbours_()):(e.setParent(null),e.bumpNeighbours_()))}this.prevParentConnection_=c
	}
};
...
Blockly.Blocks.controls_repeat={
	init:function(){
		this.jsonInit({message0:Blockly.Msg.CONTROLS_REPEAT_TITLE,
			args0:[{type:"field_input",name:"TIMES",text:"10"}],previousStatement:null,nextStatement:null,colour:
			Blockly.Blocks.loops.HUE,
			tooltip:Blockly.Msg.CONTROLS_REPEAT_TOOLTIP,helpUrl:Blockly.Msg.CONTROLS_REPEAT_HELPURL});
...
Blockly.Blocks.controls_whileUntil={
	init:function(){var a=[[Blockly.Msg.CONTROLS_WHILEUNTIL_OPERATOR_WHILE,"WHILE"],[Blockly.Msg.CONTROLS_WHILEUNTIL_OPERATOR_UNTIL,"UNTIL"]];
...
Blockly.Blocks.controls_forEach={
	init:function(){
		...
		var a=this;this.setTooltip(function(){return Blockly.Msg.CONTROLS_FOREACH_TOOLTIP.replace("%1",a.getFieldValue("VAR"))})},getVars:function(){return[this.getFieldValue("VAR")]},
		renameVar:function(a,b){Blockly.Names.equals(a,this.getFieldValue("VAR"))&&this.setFieldValue(b,"VAR")},
		customContextMenu:Blockly.Blocks.controls_for.customContextMenu};

Blockly.Blocks.controls_flow_statements={
	init:function(){var a=[[Blockly.Msg.CONTROLS_FLOW_STATEMENTS_OPERATOR_BREAK,"BREAK"],[Blockly.Msg.CONTROLS_FLOW_STATEMENTS_OPERATOR_CONTINUE,"CONTINUE"]];
	this.setHelpUrl(Blockly.Msg.CONTROLS_FLOW_STATEMENTS_HELPURL);
	this.setColour(Blockly.Blocks.loops.HUE);
	this.appendDummyInput().appendField(new Blockly.FieldDropdown(a),"FLOW");
	this.setPreviousStatement(!0);var b=this;this.setTooltip(function(){var a=b.getFieldValue("FLOW");return{BREAK:Blockly.Msg.CONTROLS_FLOW_STATEMENTS_TOOLTIP_BREAK,
...
Blockly.Blocks.math_arithmetic={
	init:function(){var a=[[Blockly.Msg.MATH_ADDITION_SYMBOL,"ADD"],[Blockly.Msg.MATH_SUBTRACTION_SYMBOL,"MINUS"],[Blockly.Msg.MATH_MULTIPLICATION_SYMBOL,"MULTIPLY"],[Blockly.Msg.MATH_DIVISION_SYMBOL,"DIVIDE"],[Blockly.Msg.MATH_POWER_SYMBOL,"POWER"]];
...
Blockly.Blocks.math_single={
	init:function(){var a=[[Blockly.Msg.MATH_SINGLE_OP_ROOT,"ROOT"],[Blockly.Msg.MATH_SINGLE_OP_ABSOLUTE,"ABS"],["-","NEG"],["ln","LN"],["log10","LOG10"],["e^","EXP"],["10^","POW10"]];
	this.setHelpUrl(Blockly.Msg.MATH_SINGLE_HELPURL);
	this.setColour(Blockly.Blocks.math.HUE);
	this.setOutput(!0,"Number");
	this.appendValueInput("NUM").setCheck("Number").appendField(new Blockly.FieldDropdown(a),"OP");var b=this;this.setTooltip(function(){var a=b.getFieldValue("OP");return{ROOT:Blockly.Msg.MATH_SINGLE_TOOLTIP_ROOT,
	ABS:Blockly.Msg.MATH_SINGLE_TOOLTIP_ABS,NEG:Blockly.Msg.MATH_SINGLE_TOOLTIP_NEG,LN:Blockly.Msg.MATH_SINGLE_TOOLTIP_LN,LOG10:
	Blockly.Msg.MATH_SINGLE_TOOLTIP_LOG10,EXP:Blockly.Msg.MATH_SINGLE_TOOLTIP_EXP,POW10:Blockly.Msg.MATH_SINGLE_TOOLTIP_POW10}[a]})
	}
};

Blockly.Blocks.math_trig={
	init:function(){var a=[[Blockly.Msg.MATH_TRIG_SIN,"SIN"],[Blockly.Msg.MATH_TRIG_COS,"COS"],[Blockly.Msg.MATH_TRIG_TAN,"TAN"],[Blockly.Msg.MATH_TRIG_ASIN,"ASIN"],[Blockly.Msg.MATH_TRIG_ACOS,"ACOS"],[Blockly.Msg.MATH_TRIG_ATAN,"ATAN"]];
	this.setHelpUrl(Blockly.Msg.MATH_TRIG_HELPURL);
	this.setColour(Blockly.Blocks.math.HUE);
	this.setOutput(!0,"Number");
	this.appendValueInput("NUM").setCheck("Number").appendField(new Blockly.FieldDropdown(a),"OP");var b=this;this.setTooltip(function(){var a=
...
Blockly.Blocks.math_number_property={
	init:function(){var a=[[Blockly.Msg.MATH_IS_EVEN,"EVEN"],[Blockly.Msg.MATH_IS_ODD,"ODD"],[Blockly.Msg.MATH_IS_PRIME,"PRIME"],[Blockly.Msg.MATH_IS_WHOLE,"WHOLE"],[Blockly.Msg.MATH_IS_POSITIVE,"POSITIVE"],[Blockly.Msg.MATH_IS_NEGATIVE,"NEGATIVE"],[Blockly.Msg.MATH_IS_DIVISIBLE_BY,"DIVISIBLE_BY"]];
	this.setColour(Blockly.Blocks.math.HUE);
	this.appendValueInput("NUMBER_TO_CHECK").setCheck("Number");a=new Blockly.FieldDropdown(a,function(a){this.sourceBlock_.updateShape_("DIVISIBLE_BY"==a)});
	this.appendDummyInput().appendField(a,"PROPERTY");
	this.setInputsInline(!0);
	this.setOutput(!0,"Boolean");
	this.setTooltip(Blockly.Msg.MATH_IS_TOOLTIP)},mutationToDom:function(){var a=document.createElement("mutation"),b="DIVISIBLE_BY"==this.getFieldValue("PROPERTY");a.setAttribute("divisor_input",b);return a},domToMutation:function(a){a="true"==a.getAttribute("divisor_input");
	this.updateShape_(a)},updateShape_:function(a){var b=this.getInput("DIVISOR");a?b||this.appendValueInput("DIVISOR").setCheck("Number"):b&&this.removeInput("DIVISOR")
	}
};

Blockly.Blocks.math_change={
	init:function(){
		this.jsonInit({message0:Blockly.Msg.MATH_CHANGE_TITLE,args0:[{type:"field_variable",name:"VAR",variable:Blockly.Msg.MATH_CHANGE_TITLE_ITEM},{type:"input_value",name:"DELTA",check:"Number"}],previousStatement:null,nextStatement:null,colour:Blockly.Blocks.math.HUE,helpUrl:Blockly.Msg.MATH_CHANGE_HELPURL});var a=this;this.setTooltip(function(){return Blockly.Msg.MATH_CHANGE_TOOLTIP.replace("%1",a.getFieldValue("VAR"))})},getVars:function(){return[this.getFieldValue("VAR")]},renameVar:function(a,
		b){Blockly.Names.equals(a,this.getFieldValue("VAR"))&&this.setFieldValue(b,"VAR")
	}
};
Blockly.Blocks.math_round={
	init:function(){var a=[[Blockly.Msg.MATH_ROUND_OPERATOR_ROUND,"ROUND"],
...
Blockly.Blocks.math_on_list={
	init:function(){var a=[[Blockly.Msg.MATH_ONLIST_OPERATOR_SUM,"SUM"],
	...
	[Blockly.Msg.MATH_ONLIST_OPERATOR_RANDOM,"RANDOM"]],b=this;this.setHelpUrl(Blockly.Msg.MATH_ONLIST_HELPURL);
	this.setColour(Blockly.Blocks.math.HUE);
	this.setOutput(!0,"Number");a=new Blockly.FieldDropdown(a,function(a){"MODE"==a?b.outputConnection.setCheck("Array"):b.outputConnection.setCheck("Number")});
	this.appendValueInput("LIST").setCheck("Array").appendField(a,"OP");
	this.setTooltip(function(){var a=b.getFieldValue("OP");return{SUM:Blockly.Msg.MATH_ONLIST_TOOLTIP_SUM,MIN:Blockly.Msg.MATH_ONLIST_TOOLTIP_MIN,MAX:Blockly.Msg.MATH_ONLIST_TOOLTIP_MAX,AVERAGE:Blockly.Msg.MATH_ONLIST_TOOLTIP_AVERAGE,MEDIAN:Blockly.Msg.MATH_ONLIST_TOOLTIP_MEDIAN,
...
Blockly.Blocks.math_constrain={
	init:function(){
		this.jsonInit({message0:Blockly.Msg.MATH_CONSTRAIN_TITLE,args0:[{type:"input_value",name:"VALUE",check:"Number"},
			...
			inputsInline:!0,output:"Number",colour:Blockly.Blocks.math.HUE,tooltip:Blockly.Msg.MATH_CONSTRAIN_TOOLTIP,
			helpUrl:Blockly.Msg.MATH_CONSTRAIN_HELPURL})
	}
};
Blockly.Blocks.math_random_int={
	init:function(){
		this.jsonInit({message0:Blockly.Msg.MATH_RANDOM_INT_TITLE,
			args0:[{type:"input_value",name:"FROM",check:"Number"},{type:"input_value",name:"TO",check:"Number"}],
			inputsInline:!0,output:"Number",colour:Blockly.Blocks.math.HUE,tooltip:Blockly.Msg.MATH_RANDOM_INT_TOOLTIP,helpUrl:
...
Blockly.Blocks.procedures_defreturn={
	init:function(){
		...
		this.setColour(Blockly.Blocks.procedures.HUE);var a=Blockly.Procedures.findLegalName(Blockly.Msg.PROCEDURES_DEFRETURN_PROCEDURE,this),a=new Blockly.FieldTextInput(a,Blockly.Procedures.rename);a.setSpellcheck(!1);
		...
		compose:Blockly.Blocks.procedures_defnoreturn.compose,dispose:Blockly.Blocks.procedures_defnoreturn.dispose,getProcedureDef:function(){
			return[this.getFieldValue("NAME"),this.arguments_,!0]},getVars:Blockly.Blocks.procedures_defnoreturn.getVars,renameVar:Blockly.Blocks.procedures_defnoreturn.renameVar,customContextMenu:Blockly.Blocks.procedures_defnoreturn.customContextMenu,callType_:"procedures_callreturn"
		};
...
Blockly.Blocks.procedures_callreturn={
	init:function(){
		...
		this.arguments_=[];
		this.quarkConnections_={};
		this.quarkArguments_=null},getProcedureCall:Blockly.Blocks.procedures_callnoreturn.getProcedureCall,renameProcedure:Blockly.Blocks.procedures_callnoreturn.renameProcedure,
...
Blockly.Blocks.text_join={
	init:function(){
		...
		this.setColour(Blockly.Blocks.texts.HUE);
		this.itemCount_=2;this.updateShape_();
		this.setOutput(!0,"String");
		this.setMutator(new Blockly.Mutator(["text_create_join_item"]));
		this.setTooltip(Blockly.Msg.TEXT_JOIN_TOOLTIP)},mutationToDom:function(){var a=document.createElement("mutation");a.setAttribute("items",this.itemCount_);return a},domToMutation:function(a){this.itemCount_=parseInt(a.getAttribute("items"),10);
...
Blockly.Blocks.text_append={
	init:function(){
		...
		this.setPreviousStatement(!0);
		this.setNextStatement(!0);var a=this;this.setTooltip(function(){return Blockly.Msg.TEXT_APPEND_TOOLTIP.replace("%1",a.getFieldValue("VAR"))})},
...
Blockly.Blocks.text_length={
	init:function(){
		this.jsonInit({message0:Blockly.Msg.TEXT_LENGTH_TITLE,
			args0:[{type:"input_value",name:"VALUE",check:["String","Array"]}],output:"Number",colour:
			Blockly.Blocks.texts.HUE,tooltip:Blockly.Msg.TEXT_LENGTH_TOOLTIP,helpUrl:Blockly.Msg.TEXT_LENGTH_HELPURL})
	}
};
Blockly.Blocks.text_isEmpty={
	init:function(){
		this.jsonInit({message0:Blockly.Msg.TEXT_ISEMPTY_TITLE,
			args0:[{type:"input_value",name:"VALUE",check:["String","Array"]}],
			output:"Boolean",colour:Blockly.Blocks.texts.HUE,tooltip:Blockly.Msg.TEXT_ISEMPTY_TOOLTIP,helpUrl:Blockly.Msg.TEXT_ISEMPTY_HELPURL})
	}
};
Blockly.Blocks.text_indexOf={
	init:function(){var a=[[Blockly.Msg.TEXT_INDEXOF_OPERATOR_FIRST,"FIRST"],[Blockly.Msg.TEXT_INDEXOF_OPERATOR_LAST,"LAST"]];
	...
	this.appendValueInput("FIND").setCheck("String").appendField(new Blockly.FieldDropdown(a),"END");Blockly.Msg.TEXT_INDEXOF_TAIL&&this.appendDummyInput().appendField(Blockly.Msg.TEXT_INDEXOF_TAIL);
...
Blockly.Blocks.text_charAt={
	init:function(){
		...
		[Blockly.Msg.TEXT_CHARAT_FROM_END,"FROM_END"],[Blockly.Msg.TEXT_CHARAT_FIRST,"FIRST"],
		[Blockly.Msg.TEXT_CHARAT_LAST,"LAST"],[Blockly.Msg.TEXT_CHARAT_RANDOM,"RANDOM"]];
...
Blockly.Blocks.text_getSubstring={
	init:function(){this.WHERE_OPTIONS_1=[[Blockly.Msg.TEXT_GET_SUBSTRING_START_FROM_START,"FROM_START"],
	...
	this.appendDummyInput("AT1");this.appendDummyInput("AT2");Blockly.Msg.TEXT_GET_SUBSTRING_TAIL&&this.appendDummyInput("TAIL").appendField(Blockly.Msg.TEXT_GET_SUBSTRING_TAIL);
	this.setInputsInline(!0);
	this.setOutput(!0,"String");
	this.updateAt_(1,!0);this.updateAt_(2,!0);
	this.setTooltip(Blockly.Msg.TEXT_GET_SUBSTRING_TOOLTIP)},mutationToDom:function(){var a=document.createElement("mutation"),b=this.getInput("AT1").type==Blockly.INPUT_VALUE;a.setAttribute("at1",b);b=this.getInput("AT2").type==Blockly.INPUT_VALUE;a.setAttribute("at2",b);return a},domToMutation:function(a){var b="true"==a.getAttribute("at1");a="true"==a.getAttribute("at2");
	this.updateAt_(1,b);
	this.updateAt_(2,a)},updateAt_:function(a,b){this.removeInput("AT"+a);
	this.removeInput("ORDINAL"+a,!0);b?(this.appendValueInput("AT"+a).setCheck("Number"),Blockly.Msg.ORDINAL_NUMBER_SUFFIX&&this.appendDummyInput("ORDINAL"+a).appendField(Blockly.Msg.ORDINAL_NUMBER_SUFFIX)):
	this.appendDummyInput("AT"+a);2==a&&Blockly.Msg.TEXT_GET_SUBSTRING_TAIL&&(this.removeInput("TAIL",!0),this.appendDummyInput("TAIL").appendField(Blockly.Msg.TEXT_GET_SUBSTRING_TAIL));var c=new Blockly.FieldDropdown(this["WHERE_OPTIONS_"+a],function(c){var e="FROM_START"==c||"FROM_END"==c;if(e!=b){var f=this.sourceBlock_;f.updateAt_(a,e);f.setFieldValue(c,"WHERE"+a);return null}});
	this.getInput("AT"+a).appendField(c,"WHERE"+a);1==a&&this.moveInputBefore("AT1","AT2")
	}
};

Blockly.Blocks.text_changeCase={
	init:function(){var a=[[Blockly.Msg.TEXT_CHANGECASE_OPERATOR_UPPERCASE,"UPPERCASE"],
...
Blockly.Blocks.text_trim={
	init:function(){var a=[[Blockly.Msg.TEXT_TRIM_OPERATOR_BOTH,"BOTH"],
...
Blockly.Blocks.text_print={
	init:function(){
		this.jsonInit({message0:Blockly.Msg.TEXT_PRINT_TITLE,args0:[{type:"input_value",name:"TEXT"}],
			previousStatement:null,nextStatement:null,colour:Blockly.Blocks.texts.HUE,
			tooltip:Blockly.Msg.TEXT_PRINT_TOOLTIP,helpUrl:Blockly.Msg.TEXT_PRINT_HELPURL})
	}
};

Blockly.Blocks.text_prompt={
	init:function(){
		var a=[[Blockly.Msg.TEXT_PROMPT_TYPE_TEXT,"TEXT"],
		[Blockly.Msg.TEXT_PROMPT_TYPE_NUMBER,"NUMBER"]],b=this;this.setHelpUrl(Blockly.Msg.TEXT_PROMPT_HELPURL);
		this.setColour(Blockly.Blocks.texts.HUE);a=new Blockly.FieldDropdown(a,function(a){"NUMBER"==a?b.changeOutput("Number"):b.changeOutput("String")});
...
Blockly.Blocks.text_prompt_ext={
	init:function(){var a=[[Blockly.Msg.TEXT_PROMPT_TYPE_TEXT,"TEXT"],[Blockly.Msg.TEXT_PROMPT_TYPE_NUMBER,"NUMBER"]],b=this;
	this.setHelpUrl(Blockly.Msg.TEXT_PROMPT_HELPURL);
	this.setColour(Blockly.Blocks.texts.HUE);a=new Blockly.FieldDropdown(a,function(a){"NUMBER"==a?b.changeOutput("Number"):b.changeOutput("String")});
	this.appendValueInput("TEXT").appendField(a,"TYPE");
	this.setOutput(!0,"String");b=this;this.setTooltip(function(){return"TEXT"==b.getFieldValue("TYPE")?
...
Blockly.Blocks.variables_get={
	init:function(){
		...
		this.contextMenuMsg_=Blockly.Msg.VARIABLES_GET_CREATE_SET},getVars:function(){return[this.getFieldValue("VAR")]},renameVar:function(a,b){
			Blockly.Names.equals(a,this.getFieldValue("VAR"))&&this.setFieldValue(b,"VAR")},contextMenuType_:"variables_set",
			customContextMenu:function(a){var b={enabled:!0},c=this.getFieldValue("VAR");
			b.text=this.contextMenuMsg_.replace("%1",c);c=goog.dom.createDom("field",null,c);
			c.setAttribute("name","VAR");c=goog.dom.createDom("block",null,c);c.setAttribute("type",this.contextMenuType_);
...
Blockly.Blocks.variables_set={
	init:function(){
		this.jsonInit(
		{
			message0:Blockly.Msg.VARIABLES_SET,args0:
			[{
